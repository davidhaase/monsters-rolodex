...
- basic state/props implementation of React, 
- linked fonts from Google,
- basic fetch of dummy name/user data for the monsters
- basic fetch of fun monster illustrations

Enormous gratitude to the tutorial instructors an *Zero to Mastery*: 
- Andrei Neagoie
- Yihua Zhang
